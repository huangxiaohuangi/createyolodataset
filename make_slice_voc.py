        ...
        for x0 in range(0, image0.shape[1], dx):
            ...
            if exiset_obj_list != []:  # 如果为空,说明切出来的这一张图不存在目标
                ...
                if zero_frac >= zero_frac_thresh:
                    ...
                    outpath = os.path.join(outdir, out_name + '_' + str(y) + '_' + str(x) + '_' + str(sliceHeight) + '_'
                                           + str(sliceWidth) + '_' + str(pad) + '_' + str(win_w) + '_' + str(win_h) + ext)
